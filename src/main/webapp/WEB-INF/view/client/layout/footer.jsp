        ...
        <div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5">
            <div class="container py-5">
                <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="https://nguyenduy.vn" target="_blank">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author:Nguyễn Duy</p>
                            <p>Website: <a href="https://nguyenduy.vn" target="_blank"> nguyenduy.vn</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://nguyenduy.vn" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>Nguyễn Duy</a>, All right
                            reserved.</span>
                    </div>
